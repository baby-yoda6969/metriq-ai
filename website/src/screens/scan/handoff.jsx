    ...
    <div className="rounded-[22px] border border-border bg-panel-alt p-5">
      ...
      {(stage === "waiting" || stage === "received") && (
        <div className="flex flex-col items-center gap-3 py-2 text-center">
          {qrDataUrl && <img src={qrDataUrl} alt={`QR code to join handoff session ${code}`} className="rounded-xl border border-border" width={200} height={200} />}
...
export function HandoffPhoneScreen({ code, products }) {
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-[480px] flex-col gap-5 bg-panel px-5 pb-8 pt-20">
      <div>
      ...
      {valid === true && sendState === "sent" && (
        <div className="flex flex-col items-center gap-3 rounded-[22px] border border-border bg-panel-alt py-10 text-center">
